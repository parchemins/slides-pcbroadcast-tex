...
\begin{frame}{Introduction}
  ...
  \vspace{3em}
    ...
    \begin{minipage}{0.24\textwidth}
      \centering
      \includegraphics[width=0.5\textwidth]{logos/facebook.png}
    \end{minipage}
    \begin{minipage}{0.24\textwidth}
      \centering
      \includegraphics[width=0.5\textwidth]{logos/mastodon.png}
    \end{minipage}
    \begin{minipage}{0.24\textwidth}
      \centering
      \includegraphics[width=0.5\textwidth]{logos/google.png}
    \end{minipage}
    \begin{minipage}{0.24\textwidth}
      \centering
      \includegraphics[width=0.7\textwidth]{logos/riak.png}
    \end{minipage}
...
\begin{frame}{Conclusion}
  ...
  messages and its negative impact on overlay's property remains low.
