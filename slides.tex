...
\begin{frame}{Introduction}
  ...
  If the sending of a message $m$ precedes the sending of a message $m'$ then
  all processes that deliver these two messages need to deliver $m$ before
...
\begin{frame}{Static systems: \YES{\cmark}}
  ...
  FIFO links and you have causal broadcast.
...
\begin{frame}{Handling failures}
  ...
  Above a buffer size threshold, retry. Too many tries, abort.
...
\begin{frame}{Experimentation: small negative impact on the overlay}
  ...
  \begin{center}
    \includegraphics[width=0.8\textwidth]{img/delay.eps}
  \end{center}
...
\begin{frame}{Conclusion}
  ...
  PC-broadcast constitutes a simple solution for causal broadcast.
